...
import { FaFileAlt, FaHome, FaShieldAlt, FaUserShield, FaLock, FaInfoCircle } from 'react-icons/fa'
        ...
        >
          {loading ? (
            ...
            <div className="space-y-8">
              {companies[0].termsPdfUrl && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
                  className="w-full h-[800px] rounded-2xl overflow-hidden border border-base-content/10 bg-base-100"
                >
                  <iframe 
            ...
            >
              ...
              <p className="text-xl text-base-content/70">{t('company.termsConditionsPlaceholder')}</p>
            </motion.div>
          )}
        </motion.div>
